...
class Ant(Insect):
    ...
    def add_to(self, place):
        ...
        elif isinstance(place.ant, ContainerAnt) == False and isinstance(self, ContainerAnt):
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, beehive):
        ...
        count = 0
        while count < self.min_range and curr_place is not beehive:
            curr_place = curr_place.entrance
            count += 1
        while curr_place is not beehive and count <= self.max_range:
...
class FireAnt(Ant):
    ...
    def reduce_armor(self, amount):
        ...
        "*** YOUR CODE HERE ***"
        copy_list = self.place.bees.copy()
...
class ContainerAnt(Ant):
    ...
    def can_contain(self, other = None):
        # BEGIN Problem 9
        "*** YOUR CODE HERE ***"
        if not other:
...
# END Problem 13
    ...
    def action(self, gamestate):
        ...
        while curr_place is not None:
            ...
            if curr_place.ant is not None and curr_place.ant.damage_doubled == False:

                curr_place.ant.damage *= 2
                curr_place.ant.damage_doubled = True

            if isinstance(curr_place.ant, ContainerAnt) and curr_place.ant.contained_ant is not None and curr_place.ant.contained_ant.damage_doubled == False:
...
def apply_status(status, bee, length):
    ...
    # BEGIN Problem EC
    "*** YOUR CODE HERE ***"
    curr_action = status(bee.action,bee)
