  ...
  'suites': [
    {
      'cases': [
        ...
        },
        {
          ...
          'will'
          >>> key_distance_diff.call_count #key_distance_diffs should be memoized, this is the first call to faster_autocorrect
          2000
          >>> key_distance_diff.call_count = 0
          >>> faster_autocorrect("woll", common_words, key_distance_diff, 4)
          'will'
          ...
          >>> autocorrect("woll", common_words, key_distance_diff, 4)
          'will'
          >>> key_distance_diff.call_count #key_distance_diffs should still be memoized but autocorrect should not be
          2000
          >>> key_distance_diff.call_count = 0
