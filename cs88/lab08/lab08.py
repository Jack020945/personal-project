...
def add_links(link1, link2):
    ...
    def identity(x):
        return x
    copy_1 = deep_map(identity, link1)
    copy_2 = deep_map(identity,link2)
    
    sentinel = copy_1
    while sentinel.rest != Link.empty:
        sentinel = sentinel.rest
    sentinel.rest = copy_2
    return copy_1
...
def lab08_extra_credit():
  ...
  practice_result_code = "1a32860b44facffe214caa686c46a4f7"
