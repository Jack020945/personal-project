...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, beehive):
        ...
        while i<self.min_range:
            ...
            i=i+1
        while current_place is not beehive and i <=self.max_range:
...
# END Problem 13
    ...
    def __init__(self, armor=1):
        ...
        for i in range(0, len(self.queens)):
            self.queens[0].is_queen = True
        # END Problem 13

    def action(self, colony,  buffer_ant=[]):
            ...
            while next is not None:
                ...
                if next.ant is not None:
                    if next.ant.is_container:
                        if next.ant.contained_ant is None:
                            if next.ant not in buffer_ant:
                                next.ant.damage = next.ant.damage * 2
                                buffer_ant.append(next.ant.contained_ant)
                        else:
                            if next.ant.contained_ant not in buffer_ant:
                                next.ant.contained_ant.damage = next.ant.contained_ant.damage * 2
                                buffer_ant.append(next.ant.contained_ant)
                            if next.ant not in buffer_ant:
                                next.ant.damage = next.ant.damage * 2
                                buffer_ant.append(next.ant)
                        buffer_ant.append(next.ant)
                    else:
                        if next.ant not in buffer_ant:
                            next.ant.damage = next.ant.damage * 2
